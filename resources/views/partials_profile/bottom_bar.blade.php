<div id="bottom_bar" class="d-lg-none">
    <ul class="clearfix">
        <li><a href="{{url('/')}}"><img src="{{asset('profile/images/house.svg')}}"> Trang chủ</a></li>
        <li><a href="#"><img src="{{asset('profile/images/search.svg')}}" alt=""> Tìm kiếm</a></li>
        <li><a href="#">
