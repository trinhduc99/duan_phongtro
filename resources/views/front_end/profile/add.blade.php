...
@section('contents_profile')
    <section role="main" class="content-body">
        @include('partials_profile.sidebar_right',['title' =>'Đăng tin mới','link'=>'Đăng tin mới','path' =>'profile.create'])
        <div class="content">
...
@endsection
@section('js_profile')
    <link rel="stylesheet" href="{{asset('profile/javascripts/main.js')}}"/>
@endsection
