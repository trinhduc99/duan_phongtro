    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <div class="footer__widget">
                    <h6>Phương thanh toán</h6>
                    <div class="footer__copyright__payment"><img src="front_end/img/payment-item.png" alt=""></div>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="footer__copyright">
                    <div class="footer__copyright__text">
                        <p>
                            ...
                            <a href="https://colorlib.com" target="_blank">nhatro.com</a>
                    </div>
                </div>
            </div>
        </div>
